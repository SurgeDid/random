...
openclose.MouseButton1Click:Connect(function()
   ...
   function lib:CreateNotification(title, text1, text2, duration, callback)
    ...
    local Confirm = Instance.new("ImageButton") -- CHANGED to ImageButton so it works
    local ImageLabel_2 = Instance.new("ImageButton") -- CHANGED to ImageButton so it works
    ...
    -- Auto timeout (this was your task.wait bug — now proper)
    task.spawn(function()
    task.wait(duration)
    fadeOutAndDestroy()
end)
    ...
    TextLabel.BorderSizePixel = 0
    TextLabel.Position = UDim2.new(0.0410464704, 0, 0.0369004086, 0)
    TextLabel.Size = UDim2.new(0, 233, 0, 34)
    TextLabel.Font = Enum.Font.SourceSansBold
    TextLabel.Text = tostring(title)
    TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    TextLabel.TextSize = 20.000
...
TextLabel_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel_2.BorderSizePixel = 0
TextLabel_2.Position = UDim2.new(0.0410464704, 0, 0.383498043, 0) -- DO NOT CHANGE
TextLabel_2.Size = UDim2.new(0, 194, 0, 16) -- initial, will grow automatically
